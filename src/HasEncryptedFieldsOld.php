...
trait HasEncryptedFieldsOld
{
     ...
     */
    public static function bootHasEncryptedFieldsOld()
    {
    ...
    {
        return openssl_encrypt($string, 'AES-128-ECB', env('APP_KEY'), 0, false);
    }
    ...
    {
        return openssl_decrypt($string, 'AES-128-ECB', env('APP_KEY'), 0, false);
    }
}
